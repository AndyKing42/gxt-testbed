...
public Widget asWidget() {
  if (panel == null) {
    final ColumnConfig<Plant, String> cc1 =
                                            new ColumnConfig<Plant, String>(properties.name(), 220,
                                                                            "Name");

    final ColumnConfig<Plant, String> cc2 =
                                            new ColumnConfig<Plant, String>(properties.light(),
                                                                            130, "Light");

    final DateCell dateCell = new DateCell(DateTimeFormat.getFormat("yyyy MMM dd"));

    final ColumnConfig<Plant, Date> cc3 =
                                          new ColumnConfig<Plant, Date>(properties.available(), 95,
                                                                        "Date");

    cc3.setCell(dateCell);

    final ColumnConfig<Plant, Boolean> cc4 =
                                             new ColumnConfig<Plant, Boolean>(properties.indoor(),
                                                                              55, "Indoor");
    ...
    final ColumnConfig<Plant, Double> cc5 =
                                            new ColumnConfig<Plant, Double>(properties.price(),
                                                                            100, "Price");
    cc5.setHorizontalAlignment(HasHorizontalAlignment.ALIGN_RIGHT);
    ...
    final ColumnModel<Plant> cm = new ColumnModel<Plant>(l);
    ...
    final SimpleComboBox<Light> combo = new SimpleComboBox<Light>(new StringLabelProvider<Light>());
    ...
    final TextButton add = new TextButton("Add Plant");
 ...
 */
protected abstract GridEditing<Plant> createGridEditing(Grid<Plant> grid1);

/**
 * Additional modifications can be made to the grid in the subclass with this method
 */
protected void customizeGrid(final Grid<Plant> grid1) {}
